...
#ifndef IMAGEVIEW_SWIFT_H
#define IMAGEVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ImageView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ImageView11AppDelegate")
...
SWIFT_CLASS("_TtC9ImageView13SceneDelegate")
...
SWIFT_CLASS("_TtC9ImageView14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified imgView;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified btnResize;
- (void)viewDidLoad;
- (IBAction)btnResizeImage:(UIButton * _Nonnull)sender;
- (IBAction)switchImageOnOff:(UISwitch * _Nonnull)sender;
