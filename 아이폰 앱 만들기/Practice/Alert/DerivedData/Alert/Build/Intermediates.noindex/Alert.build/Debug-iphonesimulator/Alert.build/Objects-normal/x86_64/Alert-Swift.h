...
#ifndef ALERT_SWIFT_H
#define ALERT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Alert",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Alert11AppDelegate")
...
SWIFT_CLASS("_TtC5Alert13SceneDelegate")
...
SWIFT_CLASS("_TtC5Alert14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified lampImg;
- (void)viewDidLoad;
- (IBAction)btnLampOn:(UIButton * _Nonnull)sender;
- (IBAction)btnLampOff:(UIButton * _Nonnull)sender;
- (IBAction)btnLampRemove:(UIButton * _Nonnull)sender;
