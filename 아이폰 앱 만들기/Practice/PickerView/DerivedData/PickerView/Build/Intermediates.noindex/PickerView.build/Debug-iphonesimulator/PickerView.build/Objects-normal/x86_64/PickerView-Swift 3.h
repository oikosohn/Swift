...
#ifndef PICKERVIEW_SWIFT_H
#define PICKERVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PickerView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PickerView11AppDelegate")
...
SWIFT_CLASS("_TtC10PickerView13SceneDelegate")
...
SWIFT_CLASS("_TtC10PickerView14ViewController")
@interface ViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, strong) IBOutlet UIPickerView * _Null_unspecified pickerImage;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified lblImageFileName;
