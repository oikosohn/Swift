...
#ifndef IMAGEVIEWMISSION_SWIFT_H
#define IMAGEVIEWMISSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ImageViewMission",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16ImageViewMission11AppDelegate")
...
SWIFT_CLASS("_TtC16ImageViewMission13SceneDelegate")
...
SWIFT_CLASS("_TtC16ImageViewMission14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified imgGallary;
- (void)viewDidLoad;
- (IBAction)btnPrevImg:(UIButton * _Nonnull)sender;
- (IBAction)btnNextImg:(UIButton * _Nonnull)sender;
