...
#ifndef PICKERVIEWMISSION_SWIFT_H
#define PICKERVIEWMISSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PickerViewMission",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17PickerViewMission11AppDelegate")
...
SWIFT_CLASS("_TtC17PickerViewMission13SceneDelegate")
...
SWIFT_CLASS("_TtC17PickerViewMission14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified lblCurrentTime;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified lblPickerTime;
- (void)viewDidLoad;
- (IBAction)changeDatePicker:(UIDatePicker * _Nonnull)sender;
- (void)updateTime;
